// src/lib.rs
/*
 * Core library for SoundSyllabus
 */
...
#[derive(Debug)]
pub struct SoundSyllabusProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SoundSyllabusProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SoundSyllabus processing");
    
    let mut processor = SoundSyllabusProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SoundSyllabusProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SoundSyllabusProcessor::new(false);
